...
in
   ...
   fun{InitGame}
      ...
      players(p1: player(port:PlayerPort pos:pt(x:2 y:2) life:InputS.nbLives id:ID spawn:pt(x:2 y:2) score:0)
              p2: player(port:Player2Port pos:pt(x:6 y:6) life:InputS.nbLives id:ID2 spawn:pt(x:12 y:6) score:0))
      else 
      players(p2: player(port:Player2Port pos:pt(x:6 y:6) life:InputS.nbLives id:ID2 spawn:pt(x:12 y:6) score:0)
   ...
   fun{InitGameBis}
      ...
      players(p1: player(port:PlayerPort pos:pt(x:2 y:2) life:InputS.nbLives id:ID spawn:pt(x:2 y:2))
              p2: player(port:Player2Port pos:pt(x:6 y:6) life:InputS.nbLives id:ID2 spawn:pt(x:12 y:6)))
   end  
